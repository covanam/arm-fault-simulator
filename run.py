...
for dir in os.listdir("swift_files"):
    for f in os.listdir(os.path.join("swift_files", dir)):
        report_name = os.path.join("reports", dir, f.split('.')[0] + ".rpt")
        print("Simulating ", f)
        os.system("./build/armory_example --armv7m {} > {}".format(os.path.join("swift_files", dir, f), report_name))
